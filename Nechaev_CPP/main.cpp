...
царь_батюшка_главный()
{
	...
	Напиток_боготырский целковый_напиток{ "Вода байкальская", 4 };
	Напиток_боготырский напиток_полушка{ "Квас пензенский", 3 };
	Напиток_боготырский напиток_четвертушка{ "Водица святая", 6 };
