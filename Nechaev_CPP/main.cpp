...
народный:
	...
	бестолочь Купить_напиток_боготырский()
	{
		...
		много_букав денюжка_внесённая;
		коли(!(Русь::внемлить >> денюжка_внесённая)) получи_басурман Русь::invalid_argument("Это вообще что такое за доллор ящерский? Мы тут только в гривнах принимаем!");
		пытать_ящера
		{
			целина(денюжка_внесённая);
		}
		поймать_ящера(Русь::беда)
		{
			получи_басурман Русь::invalid_argument("Это вообще что такое за доллор ящерский? Мы тут только в гривнах принимаем!");
		}
		...
		коли(!(Русь::внемлить >> напиток_выбранный)) получи_басурман Русь::invalid_argument("Это вообще что такое за доллор ящерский? Мы тут только в гривнах принимаем!");
